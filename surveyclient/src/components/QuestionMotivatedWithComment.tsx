...
export interface QuestionMotivatedWithCommentProps {
  sectionId: string;
  question: Question;
  questionNumber: number;
}

export default function QuestionMotivatedWithComment({
  sectionId,
  question,
  questionNumber,
    ...
    <div id={id} className="question select">
      ...
      <div className="action-row">
        <div className="toggle-button-group" aria-label={questionId}>
          {toggleButton("a", "extremely")}
          {toggleButton("b", "very")}
          {toggleButton("c", "moderately")}
          {toggleButton("d", "slightly")}
          {toggleButton("e", "not at all")}
        </div>
